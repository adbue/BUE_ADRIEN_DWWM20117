...
--
-- Hôte : 127.0.0.1:3308
-- Généré le :  mar. 18 août 2020 à 07:40
...
--
-- Base de données :  `gescom_2020-08-18`
--
...
ALTER TABLE `employees`
  ...
  ADD CONSTRAINT `employees_ibfk_4` FOREIGN KEY (`emp_sho_id`) REFERENCES `shops` (`sho_id`),
  ADD CONSTRAINT `employees_ibfk_5` FOREIGN KEY (`emp_dep_id`) REFERENCES `departments` (`dep_id`);
